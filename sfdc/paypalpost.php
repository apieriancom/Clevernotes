...
if(isset($_POST['vcode'])){
	...
	else if($payPalSandbox){
		$ppURL.='&amp;notify_url=http://www.clevernotes.org/sfdc/success.php';
		$ppURL.='&hosted_button_id=NXUG7KBDUM6L2';
		$ppURL.='&return=https://www.clevernotes.org/sfdc/pdt.php?utm_nooverride=1';
		
	}
	//Else redirect to the PayPal production button
	else {
		$ppURL.='&amp;notify_url=http://www.clevernotes.org/sfdc/success.php';
		$ppURL.='&hosted_button_id=Y62GUGJN4PJHY';
		$ppURL.='&return=https://www.clevernotes.ie/sfdc/pdt.php?utm_nooverride=1';		
	}
	$ppURL.='&item_number=TestItem';
