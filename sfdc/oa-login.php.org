...
require_once ('/var/www/vhosts/BNL1.apierian.com/httpdocs/clevernotestest/sfdc/utils.php');
...
function sfLogin($loginInfo){
	...
	if(strpos($host, '.org')){ 
		//Sandbox WSDL
		$wsdl="/var/www/vhosts/BNL1.apierian.com/httpdocs/clevernotestest/sfdc/phptoolkit/cUserLogin.sandbox.xml";
		
	}else{
		//Production WSDL
		$wsdl="/var/www/vhosts/BNL1.apierian.com/httpdocs/clevernotestest/sfdc/phptoolkit/cUserLogin.xml";
	}
  ...
  try{
		...
		if(!$result->result->success==1){			
			...
			$msg.=': Error: oa-login.php.  Line 136';
			emailAdmin($msg);
		...
		$msg=$e;
		$msg.=': Error: oa.login.php.  Line 103';
		emailAdmin($msg); 
		$ref = getenv('HTTP_REFERER');
		header("Location: $ref");
 	 }
