...
function sfLogin($loginInfo){
  ...
  try{
		...
		if($result->result->bNewUser)header("Location: https://".$_SERVER['HTTP_HOST']."/competitions/hlol/leaving-cert/share-your-views-win/");
		// Else send them to the welcome page
		else header("Location: https://www.clevernotes.ie/competitions/hlol/leaving-cert/share-your-views-win/");	
